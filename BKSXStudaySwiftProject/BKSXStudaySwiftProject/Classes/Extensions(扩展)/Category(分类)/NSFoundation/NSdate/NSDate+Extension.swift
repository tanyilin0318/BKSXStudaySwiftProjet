...
public extension NSDate{
    ...
    /// - Returns: 返回星期
    func week() -> String {
        let myWeekDay: Int = (Calendar.current as NSCalendar).components([NSCalendar.Unit.weekday], from: self as Date).weekday!
        switch myWeekDay {
        case 0:
            return "周日"
        case 1:
    ...
    /// - Parameter date: 日期
    /// - Returns: 时间字符串
    func messageAgoSinceDate(_ date: Date) -> String {
    ...
    /// - Parameters:
    ///   - date: 
    ///   - numericDates: <#numericDates description#>
